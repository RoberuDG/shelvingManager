...
from shelvingManager.Backend.Controller.shelve_controller import ShelveController
...
class Ui_MainWindow(object):
    ...
    def populate_templates(self, conn):
        ...
        for room in rooms:
            ...
            shelvings = ShelvingController.get_shelvings_by_room_id(room.id, cur)
